...
Glad to hear it! Please [tell us how we can make this documentation even better](https://github.com/navidrome/website/issues/new?template=docs_feedback.yml).

Sorry to hear that. Please [tell us how we can improve this documentation](https://github.com/navidrome/website/issues/new?template=docs_issue.yml).
